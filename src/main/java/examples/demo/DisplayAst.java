...
/**
 * A simple demonstration of how to generate and display an Abstract Syntax Tree
 * (AST). The source code should be consulted for details.
 */
public class DisplayAst extends RunTests {
     ...
     */
    public DisplayAst(String testName, PrintStream out) {
        super(testName, out);
    }
