...
/**
 * A simple demonstration of how to display the trace of the parser's path
 * through the syntax tree. The source code should be consulted for details.
 */
public class DisplayTrace extends RunTests {
     ...
     */
    public DisplayTrace(String testName, PrintStream out) {
        super(testName, out);
    }
