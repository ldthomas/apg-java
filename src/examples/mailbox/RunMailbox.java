...
/**
 * Uses the "mailbox" grammar from RFC 5321 for a comparison of timing and node
 * hits between the normal CFG grammar and the use of UDT functions. The mailbox
 * grammar is a generally accepted standard for the email addresses.
 */
